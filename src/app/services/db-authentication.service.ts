...
export class DbAuthenticationService {

  authState = new BehaviorSubject(false);

  constructor(private router: Router, private storage: Storage,  public dbService: DbService, public toastController: ToastController  ) { 
